...
* Fri Mar 29 2019 11:58:33 GMT-0700 (PDT)
* Source doc: https://docs.google.com/open?id=1umg56W0RYT-Tl_yIX8xpnEkKlUU7iZB3G4TnI7Mk6Ig
...
By David Nordfors DSI-G88 / March 2019

GitHub: https://github.com/dnordfors/galvanize-capstone
...
It is often suggested by brain science that, in general, a brain cortex performs characteristic functions on signals and that, in the absence the usual sensory signals it usually is named after, it will perform the same functions on other sensory signals. For the blind, the visual-spatial abilities are transferred to other senses, such as hearing and touch. For the deaf, the ability to hear and understand sentences is transferred to seeing and touch. Therefore it is relevant for this study to list the key factors and functions of the auditory[^3] and visual cortex, respectively:



*   **Auditory Cortex:**
    *   _Development:_
        *   The functional properties of the adult primary auditory cortex (A1) are highly dependent on the _sounds encountered early in life_. 
        *   Neurons in the auditory cortex are_ organized according to the frequency of sound_ to which they respond best
    *   _Functions:_
        *   identifying the location of a sound in space. 
        *   "Fourier transform": Identify/discern sound quality, harmony, timing, and pitch
        *   Identify/discern _"auditory objects"_ , separating them from their "raw" aspects like frequency content or echoes
        *   Identify/decode language and music:  words / sentences, riffs / melodies. 

We will be considering the analogies of these auditory functions, in the functionality of other senses. "Body language" is such an example, where research suggests that the ability to Identify language in  sound signals is transferred to visual and touch signals for the deaf. 

Note that the deaf and blind may both have in common an increased sense for touch, suggesting how Helen Keller, who became deaf and blind at the very early age of 19 months, could invent her own touch-based language, conceptualize the world around here in a similar way to the hearing and seeing, earn a B.A from Harvard and develop into a prolific author and social activist, earning her place as a pioneer in human history[^4]. It is the hypothesis of this project that the singular coolabilities of Helen Keller are not so mystical as the seeing and hearing will imagine - science suggests that she both 'heard' and 'saw', from a functional perspective, through touch - and may be a not uncommon talent to be found among deaf blind people and subsequently explored by the labor market. 

To round of this subsection, we should be encouraged to imagine how this plays out for other, until now less considered senses, such as the olefactory detection and understanding of of smell and taste.


## A High Value Labor Market for the Coolabled 

We may understand the potential for a labor market by  considering deaf people's coolabilities for reading body language, Around 55% of the comprehension between people talking with each other is said to be body language, such as understanding the importance that underlie the words being exchanged[^5].  Deaf people may be superior in jobs where this matters a lot, for example as negotiators, because body language will usually reveal a bluff and convey confidence or uncertainty. Also, it's in a  negotiators interest that the other party has registered what has been said, and a severe hearing loss can be a 'contextual coolability', by bringing the other party out of their comfort zone, similar to playing a left-handed tennis player.  A very straightforward example of a job that can be matched by coolabilities for body language is the job ad below, a highly paid GPU AI and Simulation Engineering position, building a software library for human body language.
...
[^3]:
     Auditory Cortex Function - Wikipedia: [https://en.wikipedia.org/wiki/Auditory_cortex#Function](https://en.wikipedia.org/wiki/Auditory_cortex#Function)

[^4]:
     Helen Keller - Wikipedia: [https://en.wikipedia.org/wiki/Helen_Keller](https://en.wikipedia.org/wiki/Helen_Keller)
